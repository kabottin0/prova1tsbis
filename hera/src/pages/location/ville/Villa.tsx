...
const Villa = () => {
  ...
  return (
    <>
      <div className="p-4">
        <div className="mb-4">
          <h2 className="text-3xl font-bold"> Villa {villeid}</h2>
        </div>
        <div className="mb-4">
          <p>Questa è una bellissima villa situata in una posizione pittoresca. Offre un ambiente tranquillo e confortevole con tutte le comodità moderne.</p>
        </div>
        ...
        <div className="mb-4">
          <p>Ulteriori informazioni sulla villa, i servizi offerti, le attrazioni vicine e altro ancora.</p>
        </div>
