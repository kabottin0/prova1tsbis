  ...
  return (
    <>
      ...
      <div className="flex">
        ...
        <div className="text-center w-6/12 ">
          <div className="flex">
            <div className="w-3/12 pb-10 mr-2 p-1 bg-white">
              <img src="https://via.placeholder.com/150" alt="Immagine 1" className="w-full" />
            </div>
            <div className="w-3/12 pb-10 mx-2 p-1 bg-white">
              <img src="https://via.placeholder.com/150" alt="Immagine 1" className="w-full" />
            </div>
            <div className="w-3/12 pb-10 mx-2 p-1 bg-white">
              <img src="https://via.placeholder.com/150" alt="Immagine 1" className="w-full" />
            </div>
            <div className="w-3/12 pb-10 ml-2 p-1 bg-white">
              <img src="https://via.placeholder.com/150" alt="Immagine 1" className="w-full" />
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-around items-center pt-8">
        <div className="relative group w-32 h-32 rounded-full border-4 border-white overflow-hidden">
